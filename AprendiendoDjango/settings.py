...
SECRET_KEY = 'viw!0mp+2m76dq7-f$_h+y*rz*_ssx&ygq)ece2ud#ga+5e@ea'
...
#LANGUAGE_CODE = 'en-us'
LANGUAGE_CODE = 'es-es'   # para mostrar en español
...
#Media File para imagenes y contenido multimedia
MEDIA_URL = '/media/'
